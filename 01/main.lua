...
function love.load()
   player.img = love.graphics.newImage("assets/dude.png")
   love.graphics.setBackgroundColor(122,195,255)
   jumpSND = love.audio.newSource("assets/Jump2.wav")
   hitSND = love.audio.newSource("assets/hit.wav")
   pointSND = love.audio.newSource("assets/point.wav")
